...
public class Language_Polish : LanguageBase
{
    ...
    public void Awake()
    {
        ...
        text[145] = "Rzeka czasu wyznacza drogÍ ktÛrπ kroczymy";
        text[146] = " Jedyne co moøemy zrobiÊ, to podπøaÊ tym kursem.";
        text[147] = "PodπøaÊ ... I wierzyÊ øe gdzieú tam jest coú wiÍcej.";

        // Things happen, but its just a small setback
        text[148] = "NiektÛre rzeczy, sπ nam zwyczajnie przeznaczone.";
        text[149] = "Wciπø jednak to my jesteúmy tymi wrzucanymi w wodÍ.";
        text[150] = "Pomimo tego, to wciπø my podejmujemy decyzjÍ w wielu przypadkach.";

        // Life is no small setback. It is a setback
        text[151] = "Juø nie wiem gdzie mam pok≥adaÊ wiarÍ.";
        text[152] = "Wszystko w co wierzy≥em, lego w gruzach.";
        text[153] = "A moøe wpad≥o w swoje wyznaczone miejsce ?";
        text[154] = "Jak kawa≥ki uk≥adanki stworzone na takπ konkretnπ sytuacjÍ.";

        // Life is but a stepping stone
        text[155] = "kTOú oDwAøy£ úI  mnie sPrawDZi∆ ?";
        text[156] = "MNIE ?!";
        text[157] = "Øe wogÛle mia≥ cZeLNoú∆ !";
        text[158] = "Ciekawe . . .";
        text[158] = "Oooooh, JA NIGDY siÍ nie cofam.";
        // Dig through ditches
