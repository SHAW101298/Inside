...
public class Language_Polish : LanguageBase
{
    ...
    public void Awake()
    {
        ...
        text[145] = "Just what am i afraid of ?!" // Czego ja siÍ tak w≥aúciwie bojÍ ?!
        text[146] = "That life will pass me by ?!"; // Øe øycie przeleci mi bokiem ?!
        text[147] = "This is all just a breeze ... ". // To przecieø tylko drobny wietrzyk

        // Life Goes by, just deal with it
        text[145] = "The river of time dictates the road we walk on"; // Rzeka czasu wyznacza drogÍ ktÛrπ kroczymy
        text[146] = "All we can do is follow along"; // Jedyne co moøemy zrobiÊ, to podπøaÊ tym kursem.
        text[147] = "Follow ... And belive there is something more than that." // PodπøaÊ ... I wierzyÊ øe gdzieú tam jest coú wiÍcej.

        // Things happen, but its just a small setback
        text[148] = "Some things are set in stone."; // NiektÛre rzeczy, sπ nam zwyczajnie przeznaczone
        text[149] = "But we are the ones thrown into the water."; // Wciπø jednak to my jesteúmy tymi wrzucanymi w wodÍ.
        text[150] = "There are still things that we can decide for ourselves."; // Pomimo tego, to wciπø my podejmujemy decyzjÍ w wielu przypadkach.

        // Life is no small setback. It is a setback
        text[151] = "I don't know where to put my trust anymore."; // Juø nie wiem gdzie mam pok≥adaÊ wiarÍ
        text[152] = "Everything i believed in fell apart."; // Wszystko w co wierzy≥em, lego w gruzach.
        text[153] = "Or maybe it fell into the right place ?"; // A moøe wpad≥o w swoje wyznaczone miejsce ?
        text[154] = "Like the puzzle pieces created for such an occasion."; // Jak kawa≥ki uk≥adanki stworzone na takπ konkretnπ sytuacjÍ.

        // Life is but a stepping stone
        text[155] = "sOMeOnE daReS tO TrY me ?"; // Ktoú odwaøy≥ siÍ mnie sprawdziÊ ?
        text[156] = "ME ?!"; // MNIE ?!
        text[157] = "To even have the audacity!"; // Øe wogÛle mia≥ czelnoúÊ !
        text[158] = "Interesting . . ." // Ciekawe . . . 
        text[158] = "OOOoh, I never back down !"; // Oooooh, JA nigdy siÍ nie cofam.
        // Dig through ditches
