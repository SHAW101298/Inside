...
public class Language_Polish : LanguageBase
{
    ...
    public void Awake()
    {
        ...
        text[296] = "Na poczπtek . . . PrÛbowa≥eú chociaø wys≥uchaÊ te myúli ?";
        ...
        text[350] = "I jak ? Dowiedzia≥eú siÍ czegoú uøytecznego ?";
        text[351] = "Podejrzewam, øe niezbyt.";
        text[352] = "Wiesz co siÍ mÛwi. Nie bÍdzie zmian jeúli otoczenie pozostanie to samo.";
        text[353] = "Wydaje mi siÍ, øe znajdziesz dla tego jakieú zastosowanie."; // Hands a knife to the player
    }
}