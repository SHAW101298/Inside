...
public class Language_Polish : LanguageBase
{
    ...
    void FillTextScene1()
    {
        ...
        text[141] = "pozwÛl mi byÊ przewodnikiem";
        //text[142] = "MÛg≥bym prosiÊ ciÍ o ma≥π przys≥ugÍ ?";
        text[142] = "PrzestaÒ siÍ powstrzymywaÊ";
        //text[143] = "ZostaÒ ze mnπ trochÍ d≥uøej";
        text[143] = "Zmiaødø ich koúci pod swoimi stopami";
        text[144] = "WRACAJ TU !!!";
    ...
    void FillTextScene2()
    {
        ...
        text[151] = "co jest ze mnπ nie tak";
        text[152] = "czy w≥aúnie tak to mia≥o wyglπdaÊ ?";
        text[153] = "proúciej by≥oby zwyczajnie . . .";
        ...
        text[165] = "Nikt nie wie, co znajduje siÍ po drugiej stronie";
